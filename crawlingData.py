...
url = "https://search.shopping.naver.com/search/all?exrental=true&exused=true&frm=NVSHATC&origQuery=%EB%85%B8%ED%8A%B8%EB%B6%81&pagingIndex=2&pagingSize=40&productSet=total&query=%EB%85%B8%ED%8A%B8%EB%B6%81&sort=rel&timestamp=&viewType=list"
html = urlopen(url)
bsObject = BeautifulSoup(html, "html.parser")

# for a_bo3 in bsObject.find_all('a', 'basicList_detail__27Krk'):
#     for b in a_bo3:
