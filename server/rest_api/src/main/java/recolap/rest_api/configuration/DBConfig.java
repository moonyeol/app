package recolap.rest_api.configuration;
...
@EnableJpaRepositories(
        basePackages = "recolap.rest_api.repository", // TODO Repository 패키지 지정
...
public class DBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder.dataSource(dataSource)
                .packages("recolap.rest_api.model") // TODO Model 패키지 지정
                .properties(map)
                .build();
    }
